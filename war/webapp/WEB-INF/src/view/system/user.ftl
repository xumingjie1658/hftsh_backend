...
<head>
    ...
    <!-- inject:css -->
    <link rel="stylesheet" href="/resources/assets/system/user/system.userfe36adbefa82cc5bfb34698e7d847886.css">
    <!-- endinject -->
...
<!-- inject:js -->
<script src='/resources/assets/system/user/system.userd3ce4fa3905a27bf8dc9b2322b305245.js' type='text/javascript'></script>
<!-- endinject -->
